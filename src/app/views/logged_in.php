...
?>
	...
	<div>
	<a href="<?php echo APP_CONTEXT . "/"; ?>">Cancel / Go Back</a> |
                <a href="<?php echo APP_CONTEXT . "/" . "?logout" ?>"><?php echo WORDING_LOGOUT; ?></a>
	</div>
	<br><br>
	<form method="post" action="<?php echo APP_CONTEXT . "/"; ?>" name="newEntry_form" onsubmit="return Validator();">
...
?>
	...
	<br><br>
	<form method="post" action="<?php echo APP_CONTEXT . "/"; ?>" name="newEntry_form_update" onsubmit="return Validator();">
...
?>
	<div>
	    <a href="<?php echo APP_CONTEXT . "/" . "?newEntry"?>">New Entry</a> |
		<a href="<?php echo APP_CONTEXT ."/edit"?>"><?php echo WORDING_EDIT_USER_DATA; ?></a> |
                    <a href="<?php echo APP_CONTEXT . "/" . "?logout" ?>"><?php echo WORDING_LOGOUT; ?></a>
	</div>
	<br><br>
	<?php
	...
	if ($query_user->execute()) {
		while ($row = $query_user->fetch(PDO::FETCH_ASSOC)) {
			echo "<strong><a href=".APP_CONTEXT."/?entry&id=". $row["RecordNo"] ."><font size='3'>".$row["Title"]."</font></a></strong><br><i><font size='1'>".$row["Date"]."</font></i><br><br>";
		}
	}
}
?>
