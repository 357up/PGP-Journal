...
<?php if ($login->passwordResetLinkIsValid() == true) { ?>
	<form method="post" action="<?php echo APP_CONTEXT . "/password_reset"; ?>" name="new_password_form">
...
<?php } else { ?>
<form method="post" action="<?php echo APP_CONTEXT . "/password_reset"; ?>" name="password_reset_form">
